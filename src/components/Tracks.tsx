...
const PROGRAM = [
  {
    ...
    time: "Credenciamento 15h · Cerimônia 18h30",
    items: ["Credenciamento e kit do evento", "Cerimônia de Abertura", "Palestra Magna"],
    accent: "from-pink-light to-pink",
  },
  {
    day: "12",
    weekday: "Sexta",
    label: "Palestras & Mesa Redonda",
    ...
    items: [
      ...
      "Gestão de Equipes e Equipamentos",
    ],
  ...
  },
  {
    ...
    items: ["08h30 — 12h · 6 turmas matutinas", "14h — 16h · 6 turmas vespertinas"],
