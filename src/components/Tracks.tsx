...
const PROGRAM = [
  {
    ...
    items: ["Palestra Magna: Engenheiro do Futuro", "Palavra do CREA-PI"],
  ...
  },
  {
    ...
    items: [
      ...
      "Licenciamentos na Prefeitura",
      "Responsabilidades CREA-PI",
  ...
  },
  {
    ...
    label: "Minicursos",
    time: "Manhã e Tarde",
    items: ["08h — 12h · Turno Matutino", "14h — 16h · Turno Vespertino"],
